...
public class telaConsulta extends JFrame {
	...
	public telaConsulta() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					if(nome == true && pais == true && tipo == false) {
						SQL = "select * from Figurinha where Nome LIKE '%" + nome2.getText() + "%' and Pais LIKE '%" + pais2.getText() + "%';";
					}
					if(nome == true && pais == false && tipo == true) {
						SQL = "select * from Figurinha where Nome LIKE '%" + nome2.getText() + "%' and Tipo LIKE '%" + String.valueOf(tipo2.getSelectedItem()) + "%';";
					}
					// Pais
					if(nome == false && pais == true && tipo == true) {
						SQL = "select * from Figurinha where Nome LIKE '%" + pais2.getText() + "%' and Tipo LIKE '%" + String.valueOf(tipo2.getSelectedItem()) + "%';";
					}
					
					// 3
					if(nome == true && pais == true && tipo == true) {
						SQL = "select * from Figurinha where Nome LIKE '%" + nome2.getText() + "%' and Pais LIKE '%" + pais2.getText() + "%' and Tipo LIKE '%" + String.valueOf(tipo2.getSelectedItem()) + "%';";
					}
					...
					while(resultado.next()) {
						...
						modelo.addRow(new Object[] {Figurinha.getID(), Figurinha.getNome(), Figurinha.getCod(), Figurinha.getPais(), Figurinha.getTipo()});
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				boolean id = true, Tipo2 = true, Nome = true, Codigo = true, Pais = true, Tipo = true, sql = true, sql2 = true, sql3 = true, sql4 = true;
				...
				try {
					...
					if(id == true && Tipo2 == false) {
						...
						if(Nome == false && Codigo == true && Pais == false && Tipo == false) {
							SQL = "update Figurinha set Codigo='" + Codigo_txt.getText() + "' where ID='" + ID2.getText() + "';";
						}
						...
						if(Nome == false && Codigo == false && Pais == false && Tipo == true) {
							SQL = "update Figurinha set Tipo='" + String.valueOf(Tipo_txt.getSelectedItem()) + "' where ID='" + ID2.getText() + "';";
						}
						...
						if(Nome == true && Codigo == true && Pais == false && Tipo == false) {
							SQL = "update Figurinha set Nome='" + Nome_txt.getText() + "' where ID='" + ID2.getText() + "';";
							SQL2 = "update Figurinha set Codigo='" + Codigo_txt.getText() + "' where ID='" + ID2.getText() + "';";
						}
						...
						if(Nome == true && Codigo == false && Pais == false && Tipo == true) {
							SQL = "update Figurinha set Nome='" + Nome_txt.getText() + "' where ID='" + ID2.getText() + "';";
							SQL2 = "update Figurinha set Tipo='" + String.valueOf(Tipo_txt.getSelectedItem()) + "' where ID='" + ID2.getText() + "';";
						}
						...
						if(Nome == true && Codigo == true && Pais == false && Tipo == true) {
							SQL = "update Figurinha set Nome='" + Nome_txt.getText() + "' where ID='" + ID2.getText() + "';";
							SQL2 = "update Figurinha set Codigo='" + Codigo_txt.getText() + "' where ID='" + ID2.getText() + "';";
							SQL3 = "update Figurinha set Tipo='" + String.valueOf(Tipo_txt.getSelectedItem()) + "' where ID='" + ID2.getText() + "';";
						}
						...
						if(Nome == true && Codigo == true && Pais == true && Tipo == true) {
							...
							SQL2 = "update Figurinha set Codigo='" + Codigo_txt.getText() + "' where ID='" + ID2.getText() + "';";
							SQL3 = "update Figurinha set Pais='" + Pais_txt.getText() + "' where ID='" + ID2.getText() + "';";
							SQL4 = "update Figurinha set Tipo='" + String.valueOf(Tipo_txt.getSelectedItem()) + "' where ID='" + ID2.getText() + "';";
						}
					}
					...
					if(id == false && Tipo2 == true) {
						// 1
						if(Nome == true && Codigo == false && Pais == false && Tipo == false) {
							SQL = "update Figurinha set Nome='" + Nome_txt.getText() + "' where Nome='" + Nome2.getText() + "';";
						}
						
						if(Nome == false && Codigo == true && Pais == false && Tipo == false) {
							SQL = "update Figurinha set Codigo='" + Codigo_txt.getText() + "' where Nome='" + Nome2.getText() + "';";
						}
						
						if(Nome == false && Codigo == false && Pais == true && Tipo == false) {
							SQL = "update Figurinha set Pais='" + Pais_txt.getText() + "' where Nome='" + Nome2.getText() + "';";
						}
						
						if(Nome == false && Codigo == false && Pais == false && Tipo == true) {
							SQL = "update Figurinha set Tipo='" + String.valueOf(Tipo_txt.getSelectedItem()) + "' where Nome='" + Nome2.getText() + "';";
						}
						...
						if(Nome == true && Codigo == true && Pais == false && Tipo == false) {
							SQL = "update Figurinha set Nome='" + Nome_txt.getText() + "' where Nome='" + Nome2.getText() + "';";
							SQL2 = "update Figurinha set Codigo='" + Codigo_txt.getText() + "' where Nome='" + Nome2.getText() + "';";
						}
						
						if(Nome == true && Codigo == false && Pais == true && Tipo == false) {
							SQL = "update Figurinha set Nome='" + Nome_txt.getText() + "' where Nome='" + Nome2.getText() + "';";
							SQL2 = "update Figurinha set Pais='" + Pais_txt.getText() + "' where Nome='" + Nome2.getText() + "';";
						}
						
						if(Nome == true && Codigo == false && Pais == false && Tipo == true) {
							SQL = "update Figurinha set Nome='" + Nome_txt.getText() + "' where Nome='" + Nome2.getText() + "';";
							SQL2 = "update Figurinha set Tipo='" + String.valueOf(Tipo_txt.getSelectedItem()) + "' where Nome='" + Nome2.getText() + "';";
						}
						...
						if(Nome == true && Codigo == true && Pais == true && Tipo == false) {
							SQL = "update Figurinha set Nome='" + Nome_txt.getText() + "' where Nome='" + Nome2.getText() + "';";
							SQL2 = "update Figurinha set Codigo='" + Codigo_txt.getText() + "' where Nome='" + Nome2.getText() + "';";
							SQL3 = "update Figurinha set Pais='" + Pais_txt.getText() + "' where Nome='" + Nome2.getText() + "';";
						}
						
						if(Nome == true && Codigo == true && Pais == false && Tipo == true) {
							SQL = "update Figurinha set Nome='" + Nome_txt.getText() + "' where Nome='" + Nome2.getText() + "';";
							SQL2 = "update Figurinha set Codigo='" + Codigo_txt.getText() + "' where Nome='" + Nome2.getText() + "';";
							SQL3 = "update Figurinha set Tipo='" + String.valueOf(Tipo_txt.getSelectedItem()) + "' where Nome='" + Nome2.getText() + "';";
						}
						...
						if(Nome == true && Codigo == true && Pais == true && Tipo == true) {
							...
							SQL2 = "update Figurinha set Codigo='" + Codigo_txt.getText() + "' where Nome='" + Nome2.getText() + "';";
							SQL3 = "update Figurinha set Pais='" + Pais_txt.getText() + "' where Nome='" + Nome2.getText() + "';";
							SQL4 = "update Figurinha set Tipo='" + String.valueOf(Tipo_txt.getSelectedItem()) + "' where Nome='" + Nome2.getText() + "';";
						}
					}
					...
					if(id == true && Tipo2 == true) {
						// 1
						if(Nome == true && Codigo == false && Pais == false && Tipo == false) {
							SQL = "update Figurinha set Nome='" + Nome_txt.getText() + "' where ID='" + ID2.getText() + "' and Nome='" + Nome2.getText() + "';";
						}
						
						if(Nome == false && Codigo == true && Pais == false && Tipo == false) {
							SQL = "update Figurinha set Codigo='" + Codigo_txt.getText() + "' where ID='" + ID2.getText() + "' and Nome='" + Nome2.getText() + "';";
						}
						
						if(Nome == false && Codigo == false && Pais == true && Tipo == false) {
							SQL = "update Figurinha set Pais='" + Pais_txt.getText() + "' where ID='" + ID2.getText() + "' and Nome='" + Nome2.getText() + "';";
						}
						
						if(Nome == false && Codigo == false && Pais == false && Tipo == true) {
							SQL = "update Figurinha set Tipo='" + String.valueOf(Tipo_txt.getSelectedItem()) + "' where ID='" + ID2.getText() + "' and Nome='" + Nome2.getText() + "';";
						}
						...
						if(Nome == true && Codigo == true && Pais == false && Tipo == false) {
							SQL = "update Figurinha set Nome='" + Nome_txt.getText() + "' where ID='" + ID2.getText() + "' and Nome='" + Nome2.getText() + "';";
							SQL2 = "update Figurinha set Codigo='" + Codigo_txt.getText() + "' where ID='" + ID2.getText() + "' and Nome='" + Nome2.getText() + "';";
						}
						
						if(Nome == true && Codigo == false && Pais == true && Tipo == false) {
							SQL = "update Figurinha set Nome='" + Nome_txt.getText() + "' where ID='" + ID2.getText() + "' and Nome='" + Nome2.getText() + "';";
							SQL2 = "update Figurinha set Pais='" + Pais_txt.getText() + "' where ID='" + ID2.getText() + "' and Nome='" + Nome2.getText() + "';";
						}
						
						if(Nome == true && Codigo == false && Pais == false && Tipo == true) {
							SQL = "update Figurinha set Nome='" + Nome_txt.getText() + "' where ID='" + ID2.getText() + "' and Nome='" + Nome2.getText() + "';";
							SQL2 = "update Figurinha set Tipo='" + String.valueOf(Tipo_txt.getSelectedItem()) + "' where ID='" + ID2.getText() + "' and Nome='" + Nome2.getText() + "';";
						}
						...
						if(Nome == true && Codigo == true && Pais == true && Tipo == false) {
							SQL = "update Figurinha set Nome='" + Nome_txt.getText() + "' where ID='" + ID2.getText() + "' and Nome='" + Nome2.getText() + "';";
							SQL2 = "update Figurinha set Codigo='" + Codigo_txt.getText() + "' where ID='" + ID2.getText() + "' and Nome='" + Nome2.getText() + "';";
							SQL3 = "update Figurinha set Pais='" + Pais_txt.getText() + "' where ID='" + ID2.getText() + "' and Nome='" + Nome2.getText() + "';";
						}
						
						if(Nome == true && Codigo == true && Pais == false && Tipo == true) {
							SQL = "update Figurinha set Nome='" + Nome_txt.getText() + "' where ID='" + ID2.getText() + "' and Nome='" + Nome2.getText() + "';";
							SQL2 = "update Figurinha set Codigo='" + Codigo_txt.getText() + "' where ID='" + ID2.getText() + "' and Nome='" + Nome2.getText() + "';";
							SQL3 = "update Figurinha set Tipo='" + String.valueOf(Tipo_txt.getSelectedItem()) + "' where ID='" + ID2.getText() + "' and Nome='" + Nome2.getText() + "';";
						}
						...
						if(Nome == true && Codigo == true && Pais == true && Tipo == true) {
							...
							SQL2 = "update Figurinha set Codigo='" + Codigo_txt.getText() + "' where ID='" + ID2.getText() + "' and Nome='" + Nome2.getText() + "';";
							SQL3 = "update Figurinha set Pais='" + Pais_txt.getText() + "' where ID='" + ID2.getText() + "' and Nome='" + Nome2.getText() + "';";
							SQL4 = "update Figurinha set Tipo='" + String.valueOf(Tipo_txt.getSelectedItem()) + "' where ID='" + ID2.getText() + "' and Nome='" + Nome2.getText() + "';";
						}
					}
					comando.execute(SQL);
					if(SQL == "use Album") {
