...
public class EditarFeriado extends JDialog {
	...
	public EditarFeriado() {
		...
		dataSpinner1.setModel(new SpinnerDateModel(new Date(1704078000000L), new Date(1704078000000L), null, Calendar.DAY_OF_YEAR));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if ((ano < anoModelo)) {
					JOptionPane.showMessageDialog(null,  "Não é possível pesquisar datas inferiores a 01/01/2024!", "Atenção!!",
							JOptionPane.WARNING_MESSAGE);
				}
				//Editar folga ou feriado
				ResultSet rs = FolgaDAO.getFolgas();
				ResultSet fr = FeriadoDAO.getFeriados();
				try {
